...
const SFX = {
  ...
  tick(urgent) {
    if (urgent) {
      tone(880, 0.05, 'square', 0.06, 0.003);
    } else {
      tone(600, 0.04, 'sine', 0.04, 0.003);
    }
  },

  countdownBeep() {
    tone(1000, 0.12, 'square', 0.1, 0.005);
  },
  ...
  victory() {
    ...
    notes.forEach((f, i) => {
      setTimeout(() => tone(f, 0.2, 'sine', 0.15, 0.01), i * 120);
    });
    setTimeout(() => {
